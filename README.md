...
_Analista en Ecommerce & Full Stack Web Developer_ <br>

[Email](mailto:rossidanilog@gmail.com) / [LinkedIn](https://www.linkedin.com/in/danilo-rossi-4a392045/) / [GitHub](https://github.com/rossidanilo/)

## 👩🏼‍💻 Developer Experience

**Full Stack Web Developer** @ [Datatrackers](http://datatrackers.co/) _(Aug 2019 - Present)_ <br>
Desarrollo de PWA B2B. Framework Laravel. Bootstrap, Vanilla JS, MySQL. https://github.com/rossidanilo/app-b2b
<br><br>

**Web Developer** @ [Departes](http://departes.com/) _(Oct 2017 - Sep 2020)_ <br>
Mantenimiento y customización del sitio en Shopify.
  - Implementación de calculadora de cuotas https://github.com/rossidanilo/calculador-cuotas-mercadopago
  - Implementación de validación de productos por vehículos
  - Tareas de Front-End
    <br><br>
